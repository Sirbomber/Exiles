...
{
	Player[pNo].MarkResearchComplete(8000);   // Mission 6 tech enabler

	switch (Player[pNo].Difficulty())
	{
	case 0:
		Player[0].SetKids(33);
		Player[0].SetWorkers(44);
		Player[0].SetScientists(21);
		break;
	case 1:
		Player[0].SetKids(31);
		Player[0].SetWorkers(40);
		Player[0].SetScientists(19);
		break;
	case 2:
		Player[0].SetKids(27);
		Player[0].SetWorkers(38);
		Player[0].SetScientists(16);
		break;
	}
	Player[0].SetOre(9700);
	Player[0].SetRareOre(3000);
	Player[0].SetFoodStored(6000);
}
